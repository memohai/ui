...
const VIEWPORTS: { value: 'desktop' | 'tablet' | 'mobile', icon: FunctionalComponent, label: string }[] = [
  { value: 'desktop', icon: Monitor, label: 'Desktop width' },
  { value: 'tablet', icon: Tablet, label: 'Tablet width (48rem)' },
  { value: 'mobile', icon: Smartphone, label: 'Mobile width (24rem)' },
]
